 ...
 * pre：A, b, d, e, c, f  head, left, right
 * in：d, b, e, A, c, f  left, head, right
 */
public class Code01_PreAndInArrayToPosArray {

    public static int[] makePos(int[] pre, int[] in) {
    ...
    public static void func(int[] pre, int L1, int R1,
        ...
        if (L1 == R1) {
            ...
            // the 1st of pre is the last of pos
            pos[R3] = pre[L1];
            // 定位pre中哪段是左孩子
